...
def send_welcome(message):
    ...
    bot.send_message(message.from_user.id,
                     ...
                     f'больше денег 💸 и трофеев 🏆. \n\nВ игре есть 3 сложности турниров: лёгкий, средний, сложный. \n'
                     f'За победу в лёгком турнире ты получишь 1 трофей 🏆 и $1000 💸, за победу в турниире средней '
                     f'сложности 2 трофея 🏆 и $3000 💸, а за победу в сложном турнире ты получишь $5000 💸 и 3 трофея 🏆.\n\n'
                     f'У тебя есть возможность набрать в свою команду до 11 игроков и '
                     f'продавать лишних на 30% дешевле.\n\n'
                     f'Изначально тебе будет выдан игрок 1 уровня и $3000\n'
                     f'Есть 3 уровня игроков : \n 1) 1 уровень - Новичок ($5000) \n '
                     f'2) 2 уровень - Любитель ($15000)\n 3) 3 уровень - Профессионал ($30000)\n\n'
                     f'Но не думай ты не сможешь играть одним футболистом всё время,'
                     f'у каждого игрока есть свой запас энергии он равен 3⚡️, '
                     f'1 энергия востанавливается каждые 20 минут, '
